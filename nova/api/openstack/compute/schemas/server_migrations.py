...
_migration_response = {
    ...
    'properties': {
        ...
        'disk_processed_bytes': {'type': 'integer', 'minimum': 1},
        'disk_remaining_bytes': {'type': 'integer', 'minimum': 1},
        'disk_total_bytes': {'type': 'integer', 'minimum': 1},
        'id': {'type': 'integer'},
        'memory_processed_bytes': {'type': 'integer', 'minimum': 1},
        'memory_remaining_bytes': {'type': 'integer', 'minimum': 1},
...
_migration_response['properties'].update({
